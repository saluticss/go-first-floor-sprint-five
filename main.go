...
func (r Running) Calories() float64 {
	...
	timeInMin := r.Duration.Hours() * MinInHours
	return speed * r.Weight / MInKm * timeInMin
...
func (w Walking) Calories() float64 {
	...
	meanSpeedInM := w.meanSpeed() * KmHInMsec
	...
	calories := (weightMultiplier + (math.Pow(meanSpeedInM, 2)/heightInM)*heightMultiplier) * timeInMin
